function [population, fitness_score, progress] = wine_run_ann_withGA()
...
% seed 8320 -> max 5 layers, 50 units per layer
% seed 9742 -> max 5 layers, 50 units per layer
% seed 6731 -> max 4 layers, 30 units per layer
max_hidden_layer = 4;
