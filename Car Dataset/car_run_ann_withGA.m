function [population, fitness_score, progress] = car_run_ann_withGA()
...
% load dataset
data = dlmread('transformed_car.csv');
...
% seed 7652 -> max 5 layers, 25 units per layer
% seed 6512 -> max 5 layers, 25 units per layer
% seed 2343 -> max 5 layers, 25 units per layer
max_hidden_layer = 5;
max_unit_per_layer = 25;
